...
function App() {
  const [widgets, setWidgets] = useState([
    { id: new Date().getTime(), component: <NoteWidget />, area: 'left-widget', name: "Take Note" },
    { id: new Date().getTime() + 2, component: <CalendarWidget />, area: 'floating-widget', name: "Calendar" },
    { id: new Date().getTime() + 1, component: <TimerWidget />, area: 'floating-widget', name: "Timer" },
    { id: new Date().getTime() + 4, component: <WeatherWidget />, area: 'floating-widget', name: "Weather" },
    { id: new Date().getTime() + 3, component: <SudokuWidget />, area: 'main-widget', name: "Sudoku" },
    { id: new Date().getTime() + 5, component: <YouTubeWidget />, area: 'right-widget', name: "YouTube" },
  ])
